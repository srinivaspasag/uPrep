...
new function($){
    ...
    $.goFullScreen = function(cbFnIn){
        ...
        setCallbacks();
        var docElm = $("#digitalLibrary").get(0);
...
function showTestDetailsPopup(e){
    ...
    $(".testDetailsPopupHolder").find(".chooseQuesFormat").addClass("hidden");
    $(".testDetailsPopupHolder").removeClass("hidden").find("#"+_id).removeClass("hidden");
...
$(document).on("click",".closeTestDetailsPopup",function(e){
    $(e.currentTarget).closest(".testDetailsPopupHolder").addClass("hidden");
