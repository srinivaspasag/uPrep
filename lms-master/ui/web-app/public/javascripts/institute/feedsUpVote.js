var upvoteComm = new function(){
	...
	var upvote = function(){
		...
		var params = {"entity":{"type":ent.data("entityType"),"id":ent.data("entityId")}};
	...
	var showComment = function(e){
		...
		var ent = $this.closest(".instUpvoteHolder");
		var params = {
			"parent":{"type":ent.data("entityType"),"id":ent.data("entityId")},
	...
	var showMoreComments = function(){
		...
		var params = {
			"parent":{"type":$this.data("entityType"),"id":$this.data("entityId")},
	...
	var postComment = function(e){
		...
		var params = {
			"parent":{"type":ent.data("rootType"),"id":ent.data("rootId")},
			"root":{"type":ent.data("rootType"),"id":ent.data("rootId")},
			"content":text
		};
