...
var currentMilestone = "v3.7.3"
var milestoneState= "open"
var myTeam = "Technical"
var myUsername="patilvikram"
var myPassword="Icecream39";
var outputFileName="deferred.txt";
var findLabels="status:deferred"
...
handleIssues=function( err, res ){
	if( res != null ){
		...
		for ( var i=0;i< res.length; i++ ){
			var issue=res[i];
			stream.write( "\n" );
			stream.write( issue.number+","+ issue.title+","+issue.assignee.login);
		}
		stream.end()
