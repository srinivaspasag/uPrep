...
import com.vedantu.comm.managers.MessageManager2;
...
public class MessageCenter2 extends AbstractVedantuController {

    private static final ALogger LOGGER = Logger.of(MessageCenter2.class);
    ...
    public static Result getMessageSummary() {
        ...
        try {
            ...
            response.summary = MessageManager2.get().getMessageSummary(request.orgId,
    ...
    public static Result getMessageSummaries() {
        ...
        try {
            ...
            request = requestForm.get();
            response = MessageManager2.get().getMessageSummaries(request);
        } catch (VedantuException e) {
            return ok((new JSONResponse(e)).toObjectNode());
    ...
    public static Result getConversationSummary() {
        ...
        Form<GetConversationSummaryReq> requestForm = Form.form(GetConversationSummaryReq.class)
                .bindFromRequest();
        ...
        request = requestForm.get();
        response = MessageManager2.get().getConversationSummary(request);
    ...
    public static Result getConversationSummaries() {
        ...
        try {
            ...
            request = requestForm.get();
            response = MessageManager2.get().getConversationSummaries(request);
    ...
    public static Result getMessage() {
        ...
        try {
            ...
            LOGGER.debug("Request " + requestForm.data());
            request = requestForm.get();
            response = MessageManager2.get().getMessage(request);
        } catch (VedantuException e) {
    ...
    public static Result markConversation() {
        ...
        try {
            ...
            request = requestForm.get();
            response = MessageManager2.get().markConversation(request);
    ...
    public static Result deleteConversation() {
        ...
        try {
            ...
            request = requestForm.get();
            response = MessageManager2.get().deleteUserConversation(request);
    ...
    public static Result sendMessage() {
        ...
        try {
            ...
            request = requestForm.get();
             ...
             response = MessageManager2.get().sendMessage(request);
    ...
    public static Result getConversation() {
        ...
        try {
            ...
            response = MessageManager2.get().getConversation(request);
    ...
    public static Result getConversationUsers() {
        ...
        try {
            ...
            response = MessageManager2.get().getConversationUsers(request);
    ...
    public static Result updateMailBoxInfo() {
        ...
        try {
            ...
            response = MessageManager2.get().updateUsersMailBoxesInfos(request.userIds);
