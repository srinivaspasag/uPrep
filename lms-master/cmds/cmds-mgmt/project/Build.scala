...
object ApplicationBuild extends Build {
  ...
  val appDependencies = Seq(
    ...
    "org.apache.poi" % "poi-scratchpad" % "3.9-20121203"
  )
  ...
  lazy val organizationMgmt = uri("../../organization/organization-mgmt")
  lazy val commCommons= uri("../../comm/comm-commons")
  lazy val contentMgmt= uri("../../content/content-mgmt")
  lazy val cmdsCommons= uri("../cmds-commons")
