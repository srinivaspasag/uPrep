...
public class ModifyCMDSTestQuestionsRes extends BoardSearchEntity {
	...
	public ModifyCMDSTestQuestionsRes() {
		super();
	}

	public ModifyCMDSTestQuestionsRes(String name, String id, BoardType type,
