...
public class VideoEntityFileStorage extends AbstractEntityFileStorage {

    private static final ALogger LOGGER = Logger.of(VideoEntityFileStorage.class);

    public VideoEntityFileStorage() {

        super(EntityType.VIDEO);
    }
