...
public class ExportRecordEntityFileStorage extends AbstractEntityFileStorage {

    private static final ALogger LOGGER = Logger.of(ExportRecordEntityFileStorage.class);

    public ExportRecordEntityFileStorage() {

        super(EntityType.EXPORTRECORD);
    }
