...
public class CMDSVideoStorage extends AbstractEntityFileStorage {

    private static final ALogger LOGGER = Logger.of(CMDSVideoStorage.class);

    public CMDSVideoStorage() {
        super(EntityType.CMDSVIDEO);
    }
