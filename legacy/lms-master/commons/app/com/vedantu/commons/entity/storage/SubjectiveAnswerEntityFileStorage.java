...
public class SubjectiveAnswerEntityFileStorage extends
		AbstractEntityFileStorage {
	public SubjectiveAnswerEntityFileStorage() {
		super(EntityType.SUBJECTIVEANSWER);
	}
