...
public class CMDSDocumentFileStorage extends AbstractEntityFileStorage {

    private static final ALogger LOGGER = Logger.of(CMDSDocumentFileStorage.class);

    public CMDSDocumentFileStorage() {

        super(EntityType.CMDSDOCUMENT);
    }
