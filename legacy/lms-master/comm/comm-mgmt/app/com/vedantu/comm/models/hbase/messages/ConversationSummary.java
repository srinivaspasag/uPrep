...
public class ConversationSummary extends AbstractHbaseModels implements IListResponseObj,
        IReverseImageMapperProcessor {

    public static class ConversationSummaryRecentMessageTimeSorter implements
            Comparator<ConversationSummary> {

        @Override
        public int compare(ConversationSummary o1, ConversationSummary o2) {

            return (o1.getMostRecentMessageTiming() > o2.getMostRecentMessageTiming() ? -1 : (o1
                    .getMostRecentMessageTiming() == o2.getMostRecentMessageTiming() ? 0 : 1));
        }
    }
