...
public class AVCONVVideoConverter extends ShellExecutor {
    ...
    public boolean convert(File inputVideo, File outputFileVideo) throws VedantuException {
        ...
        String fileName = inputVideo.getName();
        ...
        if (this.executionStream != null) {
            ...
            while (s.hasNextLine()) {
                ...
                if (statusRow.matches(conversionUpdatePattern)) {
                    ...
                    LOGGER.error("Completed conversion : " + completedPercentage+" "+fileName);
                }
    ...
    public boolean grabImage(File inputVideo, File grabImage, long timeOffset)
        ...
        offsetOption.value = String.valueOf(timeOffset);
