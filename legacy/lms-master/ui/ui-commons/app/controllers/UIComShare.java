 ...
 * @author ajith
 */
public class UIComShare extends AbstractUIController{
    public static void shareWith(){
        F.Promise<AbstractUIController.JSONResponseWrapper> promise = 
                client(uicom.util.ClientUtil.ORGANIZATION_SERVICE_URL+ "/organizations/getAssociatedOrgsOfUser",null);
	...
	render("UIComShare/shareWith.html",instData);
    }
    public static void getShareIndvUi(){
	render("UIComShare/shareWithIndv.html");
    }
    public static void getSharePublicUi(){
	render("UIComShare/shareWithPublic.html");
    }    
    public static void shareEntity(){
        F.Promise<JSONResponseWrapper> promise = 
                client(ClientUtil.LIB_WEB_SERVICE_URL +"/share/shareEntity",null);
        Logger.log4j.info("BEFORE AWAIT");
        await(promise);
        Logger.log4j.info("AFTER AWAIT");
    ...
    public static void shareFrndsSuggs(){ 
        ...
        F.Promise<JSONResponseWrapper> promise = 
                client(ClientUtil.SEARCH_WEB_SERVICE_URL +"/search/suggestion",allParams);
