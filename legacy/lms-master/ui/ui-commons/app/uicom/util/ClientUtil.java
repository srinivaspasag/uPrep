...
public class ClientUtil {
    ...
    public final static String LEARN_APP_URL = Play.configuration.getProperty("LEARN_APP_URL");
    ...
    public final static String TEST_SERVICE_URL = Play.configuration.getProperty("TEST_SERVICE_URL");
    ...
    public final static String MSG_WEB_SERVICE_URL = Play.configuration.getProperty("MESSAGE_WEB_SERVICE_URL");
    ...
    public enum ActivityAction{
            ...
            DEACTIVATED_ACTIVATED, REORDER, RESET, RESUMED, SYNC_USER_TEST_DATA, SET_SCHEDULE, DELETE_SCHEDULE
    }
    public enum ActivityPages{
            ...
            ,TEST_ATTEMPT,PRE_TEST,TEST_ANALYTICS,HOME,TEST_QUESTION_ATTEMPT
            //CMDS
            ...
            INVENTORY,SHIPMENTS,COUPONS, SYNC_TABLET_ANALYTICS
    }
}
