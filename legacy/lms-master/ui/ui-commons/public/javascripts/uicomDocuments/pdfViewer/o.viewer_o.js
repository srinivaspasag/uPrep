...
PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = '/public/javascripts/o.pdf.js';
...
function updateStatusToCaller(state,val){
	try{
    		window.top.docView.updateStatus(state,val);
	}catch(err){}
}
...
var PDFView = {
  ...
  initialize: function pdfViewInitialize() {
	...
	//ANIRBAN
	try{
		if(window.top.docView){ 
      			window.top.docView.onScroll(e);
		}
	}catch(err){
	}
	//END
  ...
  parseScale: function pdfViewParseScale(value, resetAutoSettings, noScroll) {
    ...
    //pdfViewerUtils.putScaledHighlights(currentPage);
  },
  ...
  error: function pdfViewError(message, moreInfo) {
    updateStatusToCaller("ERROR",moreInfo);
  ...
  progress: function pdfViewProgress(level) {
    ...
    updateStatusToCaller("PROGRESS",percent);
...
function updateViewarea() {
  ...
  //pdfViewerUtils.loadHighlights(currentId);
}
