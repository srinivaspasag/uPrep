...
public class Utilities {
        ...
        try {
            if (orgTnCInfo == null) {
                ...
                orgTnCInfo = new OrgTnCInfo(orgId, orgResp.getString("latestTnCVersion"),
                        orgResp.getBoolean("needsTnCAcceptance"), userId);
    ...
    public static JSONObject _getOrgNewWebAppInfo(String orgId) {
        JSONObject resp = null;
        try {
            resp = Register._getOrgInfoSyncCaller(orgId);
        } catch (Exception e) {
            Logger.log4j.error(e.getMessage());
        }
        return resp;
