...
<head>
    ...
    <script type="text/javascript" src="public/js/showTestUsers.js"></script>
...
<body>
    <div class="wrapper">
        ...
        <ol class="breadcrumb container">
            ...
            <div class="submitTestBtn floatRight nonner">
                <button class='btn btn-success submitEachTest'>Submit Test</button>
            </div>
        </ol>
        <div class="container tableContainer" style="overflow: auto;">
            ...
            <div id="testName" style="text-align: center;font-size: 
            20px;font-weight: 600;"></div>
            <div id="testUserData">
                <div class="">
                    <table id="test-user-table" class="table table-bordered" style="width: 100%;">
