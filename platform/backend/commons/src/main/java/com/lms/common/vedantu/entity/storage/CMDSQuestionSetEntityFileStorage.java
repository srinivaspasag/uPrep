...
@Component
public class CMDSQuestionSetEntityFileStorage extends AbstractEntityFileStorage {

	/*
	 * public CMDSQuestionSetEntityFileStorage() {
	 *
	 * super(EntityType.CMDSQUESTIONSET); }
	 */
	...
	/*
	 * @Override public FileData getData(String entityType, String mediaType, String
	 * fileName, Range ranges) throws EntityFileStorageException {
	 *
