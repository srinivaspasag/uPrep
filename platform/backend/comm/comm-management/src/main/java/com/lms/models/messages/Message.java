...
public class Message extends AbstractHbaseModels implements IReverseImageMapperProcessor {
	...
	public void removeImageSrc(boolean moveImages) throws IOException, EntityFileStorageException {
		...
		//content = MessageManager.removeTempImageSrcAndSaveToFS(EntityType.MESSAGE, content, moveImages, "comm");
	...
	public String toString() {
		...
		return "Message [action=" + action + ", content=" + content + ", conversationId=" + conversationId
				+ ", messageId=" + messageId + ", parentMessageId=" + parentMessageId + ", receivers=" + receivers
				+ ", sender=" + sender + ", sentOnTimestamp=" + sentOnTimestamp + ", subject=" + subject + ", type="
