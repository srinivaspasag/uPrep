...
(
    { $and:
        [
        {"contactNumber" :{$ne : null},"orgId":"5513a38de4b095b85aa162fd"},
        {$where:function()
    ...
    {firstName:1,lastName:1,email:1,contactNumber:1,timeCreated:1}
).
forEach
(
    function(userNew)
    {
        ...
        (
            ...
            userNew.contactNumber+","+new Date(userNew.timeCreated)+","+ programName
        )
    }
); 
