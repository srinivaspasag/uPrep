...
public abstract class AbstractEmailTemplateDetails implements IEmailTemplateDetails, IEventDetails {
      ...
      private static final Logger logger = LoggerFactory.getLogger(AbstractEmailTemplateDetails.class);
      ...
      protected AbstractEmailTemplateDetails(final String configurationName) {
            ...
            String senderEmail = EmailConfigurationConstants.SENDER;
            ...
            appDomain = Configurations.APPLEARN_HOST;
            appProtocol = Configurations.APP_PROTOCOL;
      }
