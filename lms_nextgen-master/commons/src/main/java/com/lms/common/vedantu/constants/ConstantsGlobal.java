...
public class ConstantsGlobal {
    ...
    public static final String SRC_ENTITY_DOT_ID               = "srcEntity.id";
    public static final String SRC_ENTITY_DOT_TYPE             = "srcEntity.type";
    ...
    public static final String CONTENT_SRC_DOT_ID              = "contentSrc.id";
    public static final String CONTENT_SRC_DOT_TYPE            = "contentSrc.type";
    ...
    public static final String SELLER_REF_NO                   = "sellerReferenceNo";
    public static final String POINT_OF_SALE                   = "pointOfSell";
